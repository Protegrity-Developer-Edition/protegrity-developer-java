...
[![Java 8+](https://img.shields.io/badge/java-8+-blue.svg?style=flat)](https://www.java.com/en/download/)
...
public class FindAndRedactExample {
    public static void main(String[] args) throws Exception {
        ...
        entityMap.put("SOCIAL_SECURITY_NUMBER", "SSN");
        ...
        List<PiiProcessing.EntitySpan> entities = PiiProcessing.collectEntitySpans(discoveryResult);
...
public class FindAndProtectExample {
    public static void main(String[] args) throws Exception {
        ...
        String outputText = PiiProcessing.protectData(entities, inputText, session, protector);
...
public class FindAndUnprotectExample {
    public static void main(String[] args) throws Exception {
        ...
        // Protected text from find_and_protect
        String protectedText = "[PERSON]7ro8 lfU'I[/PERSON] SSN is [SOCIAL_SECURITY_NUMBER]616-16-2210[/SOCIAL_SECURITY_NUMBER].";
        
        // Unprotect
        Protector protector = Protector.getProtector();
        SessionObject session = protector.createSession("superuser");
        String outputText = PiiProcessing.unprotectData(protectedText, session, protector);
...
public class BulkProtectExample {
    public static void main(String[] args) {
        try {
            ...
            // Protect bulk
            String[] protected = new String[data.length];
            protector.protect(session, dataElement, data, protected);
            System.out.println("Protected Data: " + Arrays.toString(protected));
            
            // Unprotect bulk
            String[] unprotected = new String[data.length];
            protector.unprotect(session, dataElement, protected, unprotected);
            System.out.println("Unprotected Data: " + Arrays.toString(unprotected));
            
        } catch (ProtectorException | SessionTimeoutException e) {
            e.printStackTrace();
        }
    }
}
...
> **💡Note:** You **do not** need Protegrity Developer Edition running before executing Application Protector Java Module.
