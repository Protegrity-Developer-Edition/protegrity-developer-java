...
public class PiiProcessing {
    ...
    public static class EntitySpan {
        ...
        /**
         * Constructs a new EntitySpan.
         * 
         * @param start the start index of the entity in the text
         * @param end the end index of the entity in the text
        ...
        /**
         * Returns the start index of the entity.
         * 
        ...
        /**
         * Returns the end index of the entity.
         * 
     ...
     * @param text the input text containing the entities (needed for Unicode code point conversion)
