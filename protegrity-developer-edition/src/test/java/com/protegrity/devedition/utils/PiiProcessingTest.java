...
public class PiiProcessingTest {
    ...
    public void testCollectEntitySpansWithEmptyJson() throws Exception {
        ...
        List<PiiProcessing.EntitySpan> spans = PiiProcessing.collectEntitySpans(entities, "test text");
    ...
    public void testCollectEntitySpansWithSingleEntity() throws Exception {
        ...
        List<PiiProcessing.EntitySpan> spans = PiiProcessing.collectEntitySpans(entities, "john.doe@example.com");
    ...
    public void testCollectEntitySpansWithMultipleEntities() throws Exception {
        ...
        List<PiiProcessing.EntitySpan> spans = PiiProcessing.collectEntitySpans(entities, "john.doe@example.com and 555-123-4567 here");
    ...
    public void testCollectEntitySpansIsSortedByStartIndex() throws Exception {
        ...
        List<PiiProcessing.EntitySpan> spans = PiiProcessing.collectEntitySpans(entities, "Contact: john.doe@example.com for info, or call 555-123-456 today.");
